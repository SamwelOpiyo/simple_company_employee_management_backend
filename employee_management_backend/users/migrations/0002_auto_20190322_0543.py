# Generated by Django 2.0.13 on 2019-03-22 05:43

from django.conf import settings
import django.core.validators
from django.db import migrations, models
import django.db.models.deletion
import employee_management_backend.users.utils
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ImageField(
                ...
                upload_to=employee_management_backend.users.utils.user_avatar_path,
                verbose_name="avatar",
            ),
        ),
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                help_text="Enter user description here.",
                max_length=500,
                verbose_name="bio",
            ),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                help_text="Select owner of address.",
